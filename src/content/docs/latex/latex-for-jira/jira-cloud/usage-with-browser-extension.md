---
title: "Usage (with browser extension)"
---
...
![LaTeX for Jira](../../../assets/-Misk9qGfHtp6SQsnwZk.png)

Type the pair **//(//)**.

![LaTeX for Jira](../../../assets/-MiskLnPxPTB81oJ5hpB.png)

Type the backtick, again. Atlassian Wiki editor will convert the content to a code block.

![LaTeX for Jira](../../../assets/-Miskfukv3TD-h2XN_qs.png)

Type the LaTeX content between the pair **//(//)**.

![LaTeX for Jira](../../../assets/-MiskqTxELPnfR2Y4uPW.png)

Click **Save** and see the result.

![LaTeX for Jira](../../../assets/-Misl-_htZLttPNFSYej.png)

### LaTeX block

Type the backtick.

![LaTeX for Jira](../../../assets/-MislVVe3mxSXjEiPuyz.png)

Type the pair **//\[//]**.

![LaTeX for Jira](../../../assets/-MismpyRkKGQxmvgSZH_.png)

Type the backtick, again. Atlassian Wiki editor will convert the content to a code block.

![LaTeX for Jira](../../../assets/-MismznYJLHjZ79IPWK8.png)

Type the LaTeX content between the pair **//\[//]**.

![LaTeX for Jira](../../../assets/-Misn7IZDw5_UzC_rr0j.png)

Click **Save** and see the result.

![LaTeX for Jira](../../../assets/-Miso7ZsocISWhNeLh8V.png)

## Plain text fields

For plain text fields like Summary, inline LaTeX must be wrapped inside `//(...//)` and LaTeX block must be wrapped inside `//[...//]`.

![LaTeX for Jira](../../../assets/-MisoDq7pq-tIBaWxcBz.png)

![LaTeX for Jira](../../../assets/-MispHg4b0ouQeSICWIE.png)

## Examples

![LaTeX for Jira](../../../assets/-MispdzT5b5T8aTwCxQa.png)

![LaTeX for Jira](../../../assets/-MisplhzbrsWDxGHd8Su.png)
