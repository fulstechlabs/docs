...
![Table Custom Field for Jira](../../assets/7Jdb1G7AXUr5Xpab7lT5.png)

Select the **Custom fields** page.

![Table Custom Field for Jira](../../assets/rrvxkSIPBMnXiyDj1SWA.png)

Click **Create custom field.** Select the **All** menu. Search for the type **Table Custom Field.** Select and click **Next**.

![Table Custom Field for Jira](../../assets/dWTWo0qBDwSJZDrihvfg.png)

The custom field will be created.

![Table Custom Field for Jira](../../assets/XsUONRUSCVA246CQ2yxS.png)
...
![Table Custom Field for Jira](../../assets/XTUiGah8lA2a8MIXPbq7.png)

Click **Create, edit or delete contexts**.

![Table Custom Field for Jira](../../assets/c8hl1QQYkxRNVHU54qH9.png)

Click on **Edit custom field config**.

![Table Custom Field for Jira](../../assets/MWXzjAw636hNlDK6OWLj.png)

Provide the configuration of columns in the table.

![Table Custom Field for Jira](../../assets/hdRzi9STy6oZkjbJuTMN.png)

## Enabling the table custom field on the issue page

Click on the **Tables** button on the toolbar.

![Table Custom Field for Jira](../../assets/R4K9zCASlLKJ2nBNlkal.png)

Click on the **Allow access** button.

![Table Custom Field for Jira](../../assets/vBIBnPcWUezOREnzKlDp.png)

Click on the **Accept** button.

![Table Custom Field for Jira](../../assets/7dyg0kKx2MotJofGeuEz.png)

The table is shown.

![Table Custom Field for Jira](../../assets/usxoONhYRts6xD5xZI49.png)

## Working with tables

Hover on the table and click on the **Edit** button. The table will switch to the edit mode.

![Table Custom Field for Jira](../../assets/OqoKrk9WvQC9R6oIm7B8.png)

To add a row, click on the **Add** ("plus" icon) button.

![Table Custom Field for Jira](../../assets/Aw4MBi3O6UrDBUCILTcA.png)

To edit a cell, hover on it and click the **Edit** ("pencil" icon) button. Use Markdown format for the content.

![Table Custom Field for Jira](../../assets/slWnZYDdPZR1oNYL3mju.png)

To remove a row, select the row by clicking on the checkbox, and click on the **Remove** ("recycle bin icon").

![Table Custom Field for Jira](../../assets/SY1S6WiiLx3OcoNtejKk.png)
