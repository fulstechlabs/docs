...
![Checklist for Jira](../../assets/-Ma8B1-aA21XSods9WTk.png)
...
![Checklist for Jira](../../assets/-Ma8B1-b2WFbkP_VFj62.png)

![Checklist for Jira](../../assets/-Ma8B1-cY9sFpEnEUi-x.png)

![Checklist for Jira](../../assets/-Ma8B1-dvXC4iJI-mLQi.png)
...
![Checklist for Jira](../../assets/qvaRD4TMySTWKIsYx8ZY.png)

When the list of options is locked, Jira users are not able to change the options.<br>

![Checklist of Jira](../../assets/K3FU02TmBw07mEyrC5Oo.png)

When the list of options is not locked, Jira users have full control of the options.

![Checklist of Jira](../../assets/cqYPIDWoNa22Y0wAkUlU.png)
