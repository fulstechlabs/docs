...
If you want to migrate all old macros to the new ones, please follow the same instructions at [Migrate to Confluence Cloud](migrate-to-confluence-cloud.md).
