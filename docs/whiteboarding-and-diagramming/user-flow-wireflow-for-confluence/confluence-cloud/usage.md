...
![User Flow (Wireflow) for Confluence](../../../assets/ZKCawnGYbLth4p3wxSwI.png)

Click **Open Editor**.

![User Flow (Wireflow) for Confluence](../../../assets/jaTBdSPUUcI4kyCL3mZL.png)

Search and drag the screens into the canvas. To rename a screen, select it and input the new name in the **Node** panel.

![User Flow (Wireflow) for Confluence](../../../assets/tURAnkYlYemYHesIvULh.png)
...
![User Flow (Wireflow) for Confluence](../../../assets/NUpM7T5phDVP0QT4TAZp.png)
...
![User Flow (Wireflow) for Confluence](../../../assets/uANrjUEA21k1JMMVHbRH.png)

Click **Insert**.

![User Flow (Wireflow) for Confluence](../../../assets/qRmnmrsIWuvioVuvec6X.png)
