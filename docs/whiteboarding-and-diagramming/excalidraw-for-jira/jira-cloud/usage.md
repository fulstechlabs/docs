...
![Excalidraw for Jira](../../../assets/yTecve2VH8Sbbut1zmMH.png)

## Create a new drawing

Click **Add New Drawing**.

![Excalidraw for Jira](../../../assets/L7Rwg1meiOSdPtGUjBLu.png)

Provide **Drawing name**, and draw some diagrams.

![Excalidraw for Jira](../../../assets/3l7VJjvLMvOTlXznecfx.png)

Draw anything you want. To draw perfect shapes like a circle, hold the **Shift** button while drawing.

![Excalidraw for Jira](../../../assets/rb3ivGyEOSPii62dfNAj.png)
...
![Excalidraw for Jira](../../../assets/wVLhlA4dNrZFaKchpDLe.png)

Open the Excalidraw Editor in Jira, and upload the library file.

![Excalidraw for Jira](../../../assets/bEzAJJXNYTPUV0fQx0kt.png)

![Excalidraw for Jira](../../../assets/76AQkGP0PN0dyT05oNef.png)

You can then drag and drop shapes into the canvas.

![Excalidraw for Jira](../../../assets/c5384M9NFMf8HMn4ewFq.png)
...
![Excalidraw for Jira](../../../assets/R1Wvw357a01xn89zzHaQ.png)

Add the selected shape to your library.

![Excalidraw for Jira](../../../assets/w7Pb8MiovrEC9HnenYNL.png)

To save your library locally (for the backup purpose, for example), click the **Export** button.

![Excalidraw for Jira](../../../assets/ob16pCbiETEEGNqymbNQ.png)
